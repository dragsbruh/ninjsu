...
(function (nin) {
    ...
    var Display = (function () {
        ...
        Display.prototype._get_keyboard_enabled = function () {
    ...
    var mouse = (function () {
        ...
        mouse.handle_mouse_move = function (e, canvas) {
    ...
    var key = (function () {
        ...
        key._enable = function (element) {
            element.addEventListener('keydown', function (e) {
                key.register_keydown(e);
            });
            element.addEventListener('keyup', function (e) {
                key.register_keyup(e);
            });
        };
        key.register_keydown = function (e) {
            var normalized_key = e.key.toUpperCase();
            key._pressed[normalized_key] = true;
        };
        key.register_keyup = function (e) {
            var normalized_key = e.key.toUpperCase();
            key._pressed[normalized_key] = false;
        };
        key.ispressed = function (key) {
            var normalizedKey = key.toUpperCase();
            return this._pressed[normalizedKey] || false;
        };
        key._is_enabled = false;
        key._pressed = {};
        return key;
    }());
    nin.key = key;
